      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="p-8 hover:shadow-lg transition-all cursor-pointer border-2 border-amber-500/20 hover:border-amber-500/40" onClick={() => setLocation("/products")}>
              <div className="text-center space-y-4">
                <div className="w-16 h-16 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-xl flex items-center justify-center mx-auto">
                  <span className="text-3xl">📦</span>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-foreground">Produtos</h3>
                  <p className="text-sm text-muted-foreground">Estoque global</p>
                </div>
              </div>
            </Card>
